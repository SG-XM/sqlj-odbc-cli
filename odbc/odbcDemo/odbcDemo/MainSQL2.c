...
"select SSN ,FNAME ,MINIT ,LNAME ,SALARY  from EMPLOYEE where DNO=:b0 for up\
date of SALARY ";
...
36,0,0,2,56,0,4,37,0,0,2,1,0,1,0,2,3,0,0,1,97,0,0,
59,0,0,3,90,0,9,47,0,0,1,1,0,1,0,1,3,0,0,
78,0,0,3,0,0,13,48,0,0,5,0,0,1,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,4,0,0,
113,0,0,4,57,0,46,54,0,0,1,1,0,1,0,1,4,0,0,
132,0,0,3,0,0,13,58,0,0,5,0,0,1,0,2,3,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,4,0,0,
167,0,0,3,0,0,15,61,0,0,0,0,0,1,0,
182,0,0,5,0,0,30,62,0,0,0,0,0,1,0,
};
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select DNUMBER into :b0  from DEPARTMENT where DNAME=:b1";
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "update EMPLOYEE  set SALARY=(SALARY+:b0) where rowid\
 = :x";
