...
static unsigned int sqlctx = 1907;
...
{13,4130,852,0,0,
5,0,0,0,0,0,27,19,0,0,4,4,0,1,0,1,97,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,92,0,4,31,0,0,6,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,1,3,0,
0,
};
...
//员工的fname
	/* varchar minit[5]; */ 
struct { unsigned short len; unsigned char arr[5]; } minit;
//员工的minit
	/* varchar lname[20]; */ 
struct { unsigned short len; unsigned char arr[20]; } lname;
//员工的lname
	/* varchar address[30]; */ 
struct { unsigned short len; unsigned char arr[30]; } address;
//员工的address
	int sal;//薪水
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select FNAME ,MINIT ,LNAME ,ADDRESS ,SALARY into :b0,:b1,:\
b2,:b3,:b4  from emp where SSN=:b5";
