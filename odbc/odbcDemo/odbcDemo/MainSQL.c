...
static unsigned int sqlctx = 75371;
...
{13,4130,852,0,0,
5,0,0,0,0,0,27,18,0,0,4,4,0,1,0,1,97,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,97,0,4,36,0,0,6,1,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,2,4,0,0,1,
3,0,0,
};
...
int main()
{
	...
	char dname[16], fname[16], lname[16], address[31];
	char bdate[11], sex[2], minit[2];
	int ssn;
	float salary, raise;
	int dno, dnumber;
...
b2,:b3,:b4  from EMPLOYEE where SSN=:b5";
